...
import Login from '@b38dev/icon/svg/login.svg?react'
import SignUp from '@b38dev/icon/svg/signup.svg?react'
import User from '@b38dev/icon/svg/user.svg?react'
import Notify from '@b38dev/icon/svg/notify.svg?react'
import Message from '@b38dev/icon/svg/message.svg?react'
import Setting from '@b38dev/icon/svg/setting.svg?react'
import Logout from '@b38dev/icon/svg/logout.svg?react'
import Light from '@b38dev/icon/svg/light.svg?react'
import Robot from '@b38dev/icon/svg/robot.svg?react'
import Up from '@b38dev/icon/svg/up.svg?react'
import './IconDock.css'
