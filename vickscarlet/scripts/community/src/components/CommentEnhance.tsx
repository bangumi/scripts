...
import { waitElement } from '@b38dev/dom'
...
import Mark from '@b38dev/icon/svg/mark.svg?react'
import Collapse from '@b38dev/icon/svg/collapse.svg?react'
import Expand from '@b38dev/icon/svg/expand.svg?react'
import Blocked from '@b38dev/icon/svg/blocked.svg?react'
import Notify from '@b38dev/icon/svg/notify.svg?react'
import Detail from '@b38dev/icon/svg/detail.svg?react'
