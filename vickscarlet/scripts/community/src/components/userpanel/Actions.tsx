...
import Home from '@b38dev/icon/svg/home.svg?react'
import Message from '@b38dev/icon/svg/message.svg?react'
import Connect from '@b38dev/icon/svg/connect.svg?react'
import DisConnect from '@b38dev/icon/svg/disconnect.svg?react'
import Blocked from '@b38dev/icon/svg/blocked.svg?react'
...
export function Actions({ data }: Props) {
    ...
    return (
        <Board as="ul" className="v-actions">
            <TipItem as="li" className="v-home" tip="主页" onClick={() => goHome(data.id)}>
                <Home />
            </TipItem>
            <TipItem
                as="li"
