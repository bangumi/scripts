...
(async function () {
  ...
  function TextSVG({ text, className }) {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className, fill: "currentColor", viewBox: `0 0 ${width} ${height}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "text",
      {
        ref: textRef,
        fontSize: 10,
