...
(async function () {
  ...
  function SickyReply({ wrapper, before }) {
    const ref = reactExports.useRef(null);
    const [sicky, setSicky] = reactExports.useState(isSicky);
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "v-sicky-reply", ref, children: reactDomExports.createPortal(
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Switch,
        {
