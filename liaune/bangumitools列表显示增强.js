// ==UserScript==
// @name         bangumitools列表显示增强
// @namespace    https://github.com/bangumi/scripts/liaune
// @version      0.2
// @description  显示作品的排名并高亮显示，显示站内评分和评分人数，显示好友评分和评分人数
// @author       Yonjar，Liaune
// @include      http://39.106.63.71/bgmtools/multitag/*
// @match        http://bgm.tv/*/browser?*
// @match        http://bgm.tv/*/browser/*
// @match        http://bgm.tv/*/tag/*
// @grant        GM_addStyle
// ==/UserScript==
...
/*           let canMatch = targetStr.match(/<small class="alarm">#(\S+?)<\/small>/);
            ...
            document.querySelectorAll('#browserItemList .item .inner')[index].insertBefore(rankSp, document.querySelectorAll('#browserItemList .item .inner span.rank')[index]);
            ...
            //显示好友评分和评分人数
            let rateInfo = document.querySelectorAll('#browserItemList .item .inner .rateInfo')[index];
