...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__bgm_eps_editor_variable__ = __webpack_require__("./lib-ts/bgm-eps-editor-variable.ts");
...
function initEditor(setting) {
    ...
    function bindEvents() {
        ...
        function applyState(state) {
            ...
            __WEBPACK_IMPORTED_MODULE_0_preact__["render"](__WEBPACK_IMPORTED_MODULE_0_preact__["h"](EpList, { current: state, pushState: pushState, popState: popState }), tableContainer, tableContainer.firstElementChild);
    ...
    var EpList = (function (_super) {
        ...
        EpList.prototype.th = function () {
            return (__WEBPACK_IMPORTED_MODULE_0_preact__["h"]("tr", null, headers.map(function (h) { return __WEBPACK_IMPORTED_MODULE_0_preact__["h"]("th", null, h); })));
        };
        ...
        EpList.prototype.tr = function () {
            ...
            return this.decodeEPs().map(function (ep, row) {
                return __WEBPACK_IMPORTED_MODULE_0_preact__["h"]("tr", null, columns.map(function (f) {
                    return __WEBPACK_IMPORTED_MODULE_0_preact__["h"]("td", null,
                        __WEBPACK_IMPORTED_MODULE_0_preact__["h"]("input", { pattern: "[^|]*", value: ep[f] || "", onKeyDown: _this.onkeydown, onPaste: _this.onPaste(row, f), onInput: _this.onInput(row, f) }));
                }));
            });
        };
        EpList.prototype.render = function () {
            return (__WEBPACK_IMPORTED_MODULE_0_preact__["h"]("table", { class: "episodes-editor-mono" },
                this.th(),
                this.tr()));
        };
        return EpList;
...
setTimeout(initEditor(__WEBPACK_IMPORTED_MODULE_1__bgm_eps_editor_variable__["a" /* getSetting */]()));
function xor(b1, b2) {
    return !!(~~b1 ^ ~~b2);
}
